...
def get_exponent(df, hist_num: int = 50, smooth_width: int = 20, d2_cutoff: float = 0.3, cutoffs = None, plot=False,
                 sd_df = None):
    assert smooth_width < hist_num
    heights, bin_edges = plot_histogram(df, num=hist_num, plot = plot)
